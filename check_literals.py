...
LITERALS = [[None, '<table'], [None, '<thead>'], [None, 'Recording'], [None, 'Screenshots'], [None, 'Callback'], [None, 'has_screenshots'], [None, 'ftc_filed'], [None, 'fcc_filed'], [None, '{vm_id}/mark'], [None, 'toggle'], [None, '<audio']]
