...
LITERALS = [[None, '@app.post("/checkmark/{vm_id}/{field}")'], [None, 'CHECKMARK_FIELDS = ("vm", "shot", "ftc", "fcc", "tcpa")'], [None, '"invalid field"'], [None, '"UPDATE voicemails SET ov_{} = ? WHERE id = ?".format(field)'], [None, '{"field": field, "value": bool(new_val)}']]
